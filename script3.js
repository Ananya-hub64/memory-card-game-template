...
const generateRandom = (size = 8) => {
    ...
    let cardValues = [];
    size= (size * size) /2;//size will double (8*8)/2 for pair of values
...
const matrixGenerator = (cardValues, size = 8)  => {
    ...
    //for displaying cards in grid in (8*8)
            ...
            if(!card.classList.contains("matched")){
                ...
                if(firstCardValue == secondCardValue) {
                    ...
                    if(winCount  == Math.floor(cardValues.length/2)) {
                        result.innerHTML = `<audio autoplay> <source src="wintune.wav" type="audio/wav"><h2>Congratulations YOU WON!</h2> <img src="win.png" alt="image">
